...
kubectl set image deployments/client-deployment client=andrzejburzynski/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=andrzejburzynski/multi-worker:$SHA
